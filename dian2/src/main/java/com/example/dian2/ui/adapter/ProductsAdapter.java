...
import com.example.dian2.di.view.ConView;
...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = View.inflate(mContext, R.layout.shop_products, null);
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder baseViewHolder, final int i) {
        ...
        baseViewHolder.customProductCounter.setOnCallBack(new ConView.CallBackListener() {
            @Override
